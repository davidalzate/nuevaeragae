...
public class ElementoViewImpl extends Composite implements ElementoView{
	...
	private void initTableColumns(
		...
		Column<ElementoDto, String>indexColumn = new Column<ElementoDto, String>(
				new EditTextCell()) {
			@Override
			public String getValue(ElementoDto object) {
				return Long.toString(object.getIndex());
			}
		};
		
		
		
		dataGrid.addColumn(indexColumn, "Index");
		nameColumn
				.setFieldUpdater(new FieldUpdater<ElementoDto, String>() {
					...
					public void update(int index, ElementoDto categoria,
							String indez) {
						categoria.setIndex(Long.parseLong(indez));
					}

				});
		
		dataGrid.setColumnWidth(indexColumn, 10, Unit.PCT);
		...
		dataGrid.addColumn(descripcionCortaColumn, "Descripci��n corta");
	...
	private DialogBox createDialogBox(String title) {
		    ...
		    Label fotoSmallLabel = new Label("Foto peque��a");
		    ...
		    indexTextBox.setWidth("25px");

	        indexTextBox.addKeyPressHandler(new KeyPressHandler() {
                 @Override
                 public void onKeyPress(KeyPressEvent event) {
                     String input = indexTextBox.getText();
		    ...
		    Button aceptButton = new Button(
		        "Aceptar", new ClickHandler() {
					...
					public void onClick(ClickEvent event) {
						...
						elementoDto.setIndex(Long.parseLong(indexTextBox.getText()));
